    ...
    if myParams.hassLts \
        ...
        try: 
            ...
            for myPce in myDb.pceList:
                ...
                sensor_name = 'sensor.' + myParams.hassDeviceName + '_' + myPce.alias.lower().replace(" ", "_") + '_consumption_stat'
                sensor_name_kwh = 'sensor.' + myParams.hassDeviceName + '_' + myPce.alias.lower().replace(" ", "_") + '_consumption_kwh_stat'
                sensor_name_pub = 'sensor.' + myParams.hassDeviceName + '_' + myPce.alias.lower().replace(" ", "_") + '_consumption_pub_stat'
                sensor_name_kwh_pub = 'sensor.' + myParams.hassDeviceName + '_' + myPce.alias.lower().replace(" ", "_") + '_consumption_kwh_pub_stat'
                sensor_name_cost = 'sensor.' + myParams.hassDeviceName + '_' + myPce.alias.lower().replace(" ", "_") + '_consumption_cost_stat'
                sensor_name_cost_pub = 'sensor.' + myParams.hassDeviceName + '_' + myPce.alias.lower().replace(" ", "_") + '_consumption_pub_cost_stat'                
